...
# v2.13-global-kdm-data.json: Global KDM data.json
export CATTLE_KDM_BRANCH="release-v2.13"
export RANCHER_MAJOR_MINOR_VERSION="2.13"

GLOBAL_KDM_FILENAME="${RANCHER_MAJOR_MINOR_VERSION}-global-kdm-data.json"


# v2.13-global-versions.txt: Global KDM 版本列表
