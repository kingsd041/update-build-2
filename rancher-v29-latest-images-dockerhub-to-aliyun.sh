...
# v2.9-global-kdm-data.json: Global KDM data.json
export CATTLE_KDM_BRANCH="release-v2.9"
export RANCHER_MAJOR_MINOR_VERSION="2.9"

GLOBAL_KDM_FILENAME="${RANCHER_MAJOR_MINOR_VERSION}-global-kdm-data.json"


# v2.9-global-versions.txt: Global KDM 版本列表
