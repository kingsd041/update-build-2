...
# v2.12-global-kdm-data.json: Global KDM data.json
export CATTLE_KDM_BRANCH="release-v2.12"
export RANCHER_MAJOR_MINOR_VERSION="2.12"

GLOBAL_KDM_FILENAME="${RANCHER_MAJOR_MINOR_VERSION}-global-kdm-data.json"


# v2.12-global-versions.txt: Global KDM 版本列表
