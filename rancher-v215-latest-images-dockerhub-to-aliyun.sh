...
# v2.15-global-kdm-data.json: Global KDM data.json
export CATTLE_KDM_BRANCH="release-v2.15"
export RANCHER_MAJOR_MINOR_VERSION="2.15"

GLOBAL_KDM_FILENAME="${RANCHER_MAJOR_MINOR_VERSION}-global-kdm-data.json"


# v2.15-global-versions.txt: Global KDM 版本列表
